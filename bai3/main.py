...
# Đọc dữ liệu từ file player_data.txt
# Giả sử file sử dụng ký tự tab làm phân tách, bạn có thể điều chỉnh `delimiter` nếu cần.
df = pd.read_csv(r'E:/World/Code/Python/BTL/bai1/file/result.csv', header=[0, 1, 2])
...
print(df[['name', 'nation', 'team']].head())  # Cập nhật tên cột nếu cần
