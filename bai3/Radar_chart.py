...
if __name__ == "__main__":
    ...
    parser.add_argument('--file', type=str, default='E:/World/Code/Python/BTL/bai3/file/result.csv')
    ...
    plt.savefig('E:/World/Code/Python/BTL/bai3/file/radar_charts.png', bbox_inches='tight')
    plt.show()
