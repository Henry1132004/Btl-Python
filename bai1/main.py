...
#
# # Lưu vào file Excel
# wb.save('E:/World/Code/Python/BTL/bai1/file/result.csv')
# print("Exam 1 Success - Player Data Saved")
#
# # Lưu dữ liệu vào file Excel cho squad_manager
...
#
# # Lưu vào file Excel
# wb2.save('E:/World/Code/Python/BTL/bai1/file/result2.csv')
# print("Exam 1 Success - Squad Data Saved")


# Lưu dữ liệu của player_manager vào file .txt
# with open('E:/World/Code/Python/BTL/bai1/file/player_data.txt', 'w', encoding='utf-8') as file:
...
#
# print("Exam 1 Success - Player Data Saved in TXT file")
#
# # Lưu dữ liệu của squad_manager vào file .txt
# with open('E:/World/Code/Python/BTL/bai1/file/squad_data.txt', 'w', encoding='utf-8') as file:
...
#         file.write("\t".join(map(str, r)) + "\n")
#
# print("Exam 1 Success - Squad Data Saved in TXT file")
#
...
with open('E:/World/Code/Python/BTL/bai1/file/result2.csv', mode='w', newline='', encoding='utf-8') as file:
    writer = csv.writer(file)
